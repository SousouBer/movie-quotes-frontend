  ...
  <div>
    ...
    <div class="relative">
      <input
        ...
        class="w-full outline-none text-white sm:text-black text-lg sm:rounded-[4.8px] bg-transparent border-gray-300 sm:bg-gray-300 sm:px-2.5 py-2 mt-1 placeholder:text-shade-of-gray placeholder:text-base"
        v-model="value"
        :type="setInputType"
        :name="props.name"
